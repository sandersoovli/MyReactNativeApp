...
// Google Sign-In seadistus (pane siia oma webClientId Firebase konsoolist)
GoogleSignin.configure({
  webClientId: 'SIIT_PANE_SINU_WEB_CLIENT_ID',
});
...
export default function Login() {
  ...
  const handleLogin = () => {
    ...
    // Hiljem lisa Firebase email/password autentimine
  ...
  const handleGmailLogin = async () => {
    try {
      ...
      console.log('Gmail login clicked', userInfo);
...
const styles = StyleSheet.create({
  ...
  GmailSignInButton: { width: 200, height: 60, borderRadius: 8, backgroundColor: '#DB4437', justifyContent: 'center', alignItems: 'center' },
