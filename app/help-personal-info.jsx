...
export default function HelpPersonalInfo() {
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.text}>
          Here you can manage your profile details, such as your name, email, and other personal information. 
          Make sure your information is up to date for the best experience.
        </Text>
      </ScrollView>
